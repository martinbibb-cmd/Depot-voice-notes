...
const primitives = {
  ...
  discharge: () => `${path('M10 8h14v13h12v19')}${path('M31 35l5 5 5-5')}${circle(10,8,3)}`,
...
export const VISUAL_COMPONENTS = {
  ...
  discharge: { actions:[['Retain','Retain'],['Replace','Alter'],['New','Install new']], section:'Condensate and discharge' },
